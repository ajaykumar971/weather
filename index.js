...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Hyderabad', options)
     ...
     .then(response => {
          ...
          hyd5.innerHTML = response.sunrise
          hyd6.innerHTML = response.sunset
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=lucknow', options)
     ...
     .then(response => {
          ...
          luck5.innerHTML = response.sunrise
          luck6.innerHTML = response.sunset
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=chennai', options)
     ...
     .then(response => {
          ...
          chen5.innerHTML = response.sunrise
          chen6.innerHTML = response.sunset
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Bhubaneswar', options)
     ...
     .then(response => {
          ...
          gn5.innerHTML = response.sunrise
          gn6.innerHTML = response.sunset
